...
module Domains
  ...
  class ContentProfileDomain < DomainsBase
    ...
    #         :resource_options=>{
    #           :uri=>"Activity/Partner/0099",
    #           :role=>"Services.UserGroups.Use.FileDownload.Pdf",
    #           :role_opts=>["0099"]
    #         },
    ...
    # }
    #
    # {:success=>true, :message=>"AccessProfile Entries for vptester:Vendor Primary User Options=VendorPrimary,0099", :user_options=>["VendorPrimary", "0099"], :accessible_content_url=>"/profiles/api_accessible_content.json?id=access", :page_user=>"vptester", :access_profile=>{:success=>true, :entries=>[{:uri=>"Activity/Partner/0099", :resource_options=>[{:uri=>"Activity/Partner/0099", :role=>"Services.UserGroups.Use.FileDownload.Pdf", :role_opts=>["0099"]}], :content_type=>"Activity", :content_value=>["*.pdf"], :topic_type=>"Partner", :topic_value=>["0099"], :description=>"Partner Relationship Reports", :topic_type_description=>"Partner Relationship Reports", :content_type_description=>"Partner Relationship Reports", :username=>"vptester", :user_options=>["VendorPrimary", "0099"]}, {:uri=>"FileDownload/UserGroups/Pdf", :resource_options=>[{:uri=>"FileDownload/UserGroups/Pdf", :role=>"Services.UserGroups.Use.FileDownload.Pdf", :role_opts=>["VendorSecondary", "VendorPrimary", "EmployeeSecondary", "EmployeePrimary"]}], :content_type=>"FileDownload", :content_value=>["*.pdf"], :topic_type=>"UserGroups", :topic_value=>["VendorPrimary"], :description=>"Permission to Download PDF Files", :topic_type_description=>"Permission to Download PDF Files", :content_type_description=>"Permission to Download PDF Files", :username=>"vptester", :user_options=>["VendorPrimary", "0099"]}, {:uri=>"FileDownload/UserGroups/Datafiles", :resource_options=>[{:uri=>"FileDownload/UserGroups/Datafiles", :role=>"Services.UserGroups.Use.FileDownload.Datafile", :role_opts=>["VendorSecondary", "VendorPrimary", "EmployeeSecondary", "EmployeePrimary"]}], :content_type=>"FileDownload", :content_value=>["*.log"], :topic_type=>"UserGroups", :topic_value=>["VendorPrimary"], :description=>"Permission to Download Data Files", :topic_type_description=>"Permission to Download Data Files", :content_type_description=>"Permission to Download Data Files", :username=>"vptester", :user_options=>["VendorPrimary", "0099"]}, {:uri=>"FileDownload/UserGroups/Images", :resource_options=>[{:uri=>"FileDownload/UserGroups/Images", :role=>"Services.UserGroups.Use.FileDownload.Image", :role_opts=>["VendorSecondary", "VendorPrimary", "EmployeeSecondary", "EmployeePrimary"]}], :content_type=>"FileDownload", :content_value=>["*.png", "*.jpg"], :topic_type=>"UserGroups", :topic_value=>["VendorPrimary"], :description=>"Permission to Download Image Files", :topic_type_description=>"Permission to Download Image Files", :content_type_description=>"Permission to Download Image Files", :username=>"vptester", :user_options=>["VendorPrimary", "0099"]}], :pak=>"63001ba01dfe8c5f888fd579c6a4cfdc", :profile_type=>"VendorPrimary", :profile_type_description=>"VendorPrimary", :provider=>"Secure::AccessRegistry", :username=>"vptester", :assigned_group=>["VendorPrimary"], :user_options=>["VendorPrimary", "0099"], :display_name=>"Vendor Primary User", :email=>"appdev4@localhost.com"}}
