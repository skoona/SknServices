...
class ProfilesController < ApplicationController
  ...
  def content_profile_demo
    @page_controls = profile_service.handle_demo_page(params)
    flash.notice.now = @page_controls.message if @page_controls.message.present?
  end

  # GET
  def manage_content_profiles
    @page_controls = profile_service.handle_content_profile_management(params)
  ...
  def api_accessible_content
    @page_controls = profile_service.handle_api_accessible_content(params)
  ...
  def api_get_content_object
    @page_controls = profile_service.api_get_content_object(params)
