...
class AccessRegistryTestUser
  ...
  attr_accessor :roles, :unique_id, :username, :assigned_roles, :display_name,
                :assigned_groups, :remember_token, :person_authentication_key, :user_options

  def initialize(params=nil)
    @roles = params || [] # is an [] or roles
    @person_authentication_key = @unique_id = SecureRandom.hex(16)
  ...
  def self.attribute_names
    [
      ...
      "assigned_groups", "remember_token", "person_authentication_key"
    ]
  end
