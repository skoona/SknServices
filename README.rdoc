...
{
    "id"=>"access",
    "uri"=>"FileDownload/UserGroups/VendorPrimary",
    "resource_options"=>{
        "0"=>{
            "uri"=>"FileDownload/UserGroups/VendorPrimary",
            "role"=>"Services.UserGroups.FileDownload.Access",
            "role_opts"=>["Developer", "Manager", "EmployeePrimary", "EmployeeSecondary",
                          "BranchPrimary", "BranchSecondary", "VendorPrimary"]
            }
    },
    "content_type"=>"FileDownload",
    "content_value"=>["*.png", "*.jpg", "*.pdf", "*.log"],
    "topic_type"=>"UserGroups",
    "topic_value"=>["EmployeeSecondary"],
    "description"=>"Permission to Download VendorPrimary Files",
    "topic_type_description"=>"Permission to Download VendorPrimary Files",
    "content_type_description"=>"Permission to Download VendorPrimary Files",
    "username"=>"estester",
